...
PRODUCT_COPY_FILES += \
    ...
    device/samsung/jet/init.jet.usb.rc:root/init.jet.usb.rc\
    device/samsung/jet/ueventd.jet.rc:root/ueventd.jet.rc \
    device/samsung/jet/recovery.rc:root/recovery.rc \
    device/samsung/jet/recovery.fstab:root/misc/recovery.fstab
...
PRODUCT_COPY_FILES += \
    device/samsung/jet/S3C24XX_TouchScreen.idc:system/usr/idc/S3C24XX_TouchScreen.idc
...
# SurfaceFlinger hack to prevent PMEM crash
PRODUCT_PROPERTY_OVERRIDES += \
        ro.config.hwc.force_min_window=true \
